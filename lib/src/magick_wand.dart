...
class MagickWand {
  ...
  Future<bool> magickAnimateImages(String serverName) async => await compute(
        _magickAnimateImages,
...
Future<bool> _magickAnimateImages(_MagickAnimateImagesParams params) async =>
    using(
