...
class KernelInfo {
  ...
  Pointer<_KernelInfoStruct> _toKernelInfoStructPointer({required Allocator allocator}) {
    ...
    kernelInfoStruct.ref.values = values?.toDoubleArrayPointer(allocator: allocator) ?? nullptr;
    ...
    kernelInfoStruct.ref.next = next?._toKernelInfoStructPointer(allocator: allocator) ?? nullptr;
